...
class Remover_sistema_de_notificacao(Notificador):
    def __init__(self, perfil, seguidores):
        self.perfil = perfil
        self.seguidores = seguidores
        self.perfil.adicionar_sistema_de_notificacao(self)
    ...
    def notificar(self):
        print(f"Removendo sistema de notificação: {self.seguidores}")
...
if __name__ == "__main__":
    ...
    Remover_sistema_de_notificacao(meuPerfil, seguidores_email)
